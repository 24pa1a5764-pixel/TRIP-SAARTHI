    ...
    <div className="fixed inset-0 ts-gradient-hero flex flex-col">
      ...
      >
        <button
          ...
          className="w-full bg-card text-card-foreground font-bold py-4 px-6 text-[15px] rounded-2xl ts-shadow-elevated flex items-center justify-center gap-3 transition active:scale-95"
        >
